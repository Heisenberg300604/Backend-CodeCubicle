...
import { authentication } from '../Config/FirebaseConfiguration.js';
  ...
  return (
    <div className="h-screen bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: "url('/beach2.jpg')"}} >
      <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white">
        ...
        <div className='p-3'>
          <button onClick={loginUsingEmail} class="w-full mb-4 mt-1 bg-blue-500 hover:bg-blue-600 active:scale-95 px-5 py-2.5 font-medium rounded-lg text-sm text-center text-white" >
            Sign in
          </button>
